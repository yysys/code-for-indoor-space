...
public class Functions {
	...
	public static boolean isInBuilding(Point randomPoint) {
		...
		if (x < DataGenConstant.outRectLeft.getX2()
				&& DataGenConstant.outRectLeft.containVertical(randomPoint)) {
			return false;
		}
		if (x > DataGenConstant.outRectRight.getX1()
				&& DataGenConstant.outRectRight.containVertical(randomPoint)) {
			return false;
		}
		if (y < DataGenConstant.outRectTop.getY2()
				&& DataGenConstant.outRectTop.containVertical(randomPoint)) {
			return false;
		}
		if (y > DataGenConstant.outRectBottom.getY1()
				&& DataGenConstant.outRectBottom.containVertical(randomPoint)) {
			return false;
		}
		return true;
	}
